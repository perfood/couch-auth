...
class User {
    ...
    createSession(user_id, provider, req = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const finalUser = yield this.logoutUserSessions(userDoc, Cleanup.expired);
            user = finalUser;
    ...
    logoutSession(session_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield __classPrivateFieldGet(this, _dbAuth).removeKeys(session_id);
            let caughtError = {};
            try {
                const removals = [__classPrivateFieldGet(this, _session).deleteTokens(session_id)];
                if (user) {
                    removals.push(__classPrivateFieldGet(this, _dbAuth).deauthorizeUser(user, session_id));
                }
                yield Promise.all(removals);
                // Clean out expired sessions
                const finalUser = yield this.logoutUserSessions(user, Cleanup.expired);
                user = finalUser;
                if (user.session) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (results.rows.length) {
                ...
                if (user.session && user.session[session_id]) {
                    const finalUser = yield this.logoutUserSessions(user, Cleanup.other, session_id);
                    return this.userDB.insert(finalUser);
                }
            }
            return false;
    ...
    logoutUserSessions(userDoc, op, currentSession) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (sessions.length) {
                ...
                yield __classPrivateFieldGet(this, _dbAuth).removeKeys(sessions);
                // 2.) Deauthorize keys from each personal database and from session store
                yield Promise.all([
                    __classPrivateFieldGet(this, _dbAuth).deauthorizeUser(userDoc, sessions),
                    __classPrivateFieldGet(this, _session).deleteTokens(sessions)
                ]);
    ...
    removeUser(user_id, destroyDBs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield this.logoutUserSessions(userDoc, Cleanup.all);
