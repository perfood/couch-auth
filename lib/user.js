...
const sofa_model_1 = __importDefault(require("sofa-model"));
...
class User {
    constructor(config, userDB, couchAuthDB, mailer, emitter) {
        ...
        this.passwordConstraints = extend_1.default(true, {}, this.passwordConstraints, config.getItem('local.passwordConstraints'));
    ...
    createUser(form, req) {
        ...
        if (typeof newUserModel === 'object') {
            ...
            finalUserModel = extend_1.default(true, {}, this.userModel, this.config.getItem('userModel'));
    ...
    changeEmail(user_id, newEmail, req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const finalUser = yield this.logActivity(user._id, 'changed email', 
            // @ts-ignore
            req.user.provider, req, user);
            return this.userDB.insert(finalUser);
        });
    }
